...
import com.wzh.fun.ui.activity.LoginActivity;
import com.wzh.fun.ui.activity.RegestActivity;
import com.wzh.fun.view.CircleImageView;
import com.wzh.fun.view.Menu;

import static com.wzh.fun.R.id.mean;
...
public abstract class BaseFragment<T> extends Fragment {
    ...
    private TextView loginTv, regTv;
    private Menu menu;
    ...
    private void init() {
        ...
        regTv = (TextView) findViewById(R.id.reg_tv);
    ...
    public void setHeadView() {
        menu = (Menu) getActivity().findViewById(R.id.activity_menu);
        CircleImageView headView = (CircleImageView) findViewById(R.id.toolbar_left_head);
